...
<div ba><button bt onclick="Calc()">Calc</button bt>|<button bt onclick="Tab()">Tab</button bt>|<button bt onclick="Reset()">Reset</button bt></div ba>
